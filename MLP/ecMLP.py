...
class Config:
    ...
    mlp_layers: int = 9
    climsim_path: str = '/global/u2/z/zeyuanhu/nvidia_codes/Climsim_private/'
    save_path: str = "./save_output"
    data_path: str = "./data"
    val_input: str = 'val_input.npy'
    val_target: str = 'val_target.npy'
    input_mean: str = 'inputs/input_mean_v4_pervar.nc'
    input_max: str = 'inputs/input_max_v4_pervar.nc'
    input_min: str = 'inputs/input_min_v4_pervar.nc'
    output_scale: str = 'outputs/output_scale_std_lowerthred.nc'
